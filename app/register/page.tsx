    ...
    <div className="card" style={{ maxWidth: 720, margin: "40px auto", textAlign: "center" }}>
      ...
      <form className="grid" onSubmit={onSubmit} style={{ textAlign: "left" }}>
        ...
        <div className="grid grid-3">
          ...
          <label>Estado<input value={form.state} onChange={(e) => setForm({ ...form, state: e.target.value })} required /></label>
        </div>
        <div className="grid grid-2">
          <label>CEP<input value={form.zipCode} onChange={(e) => setForm({ ...form, zipCode: e.target.value })} required /></label>
